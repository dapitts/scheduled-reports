...
<div class="modal-dialog" role="document">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title">Create Scheduled Report</h4>
		</div>
		...
		<?php echo form_open('/console/reports/do_create_scheduled_report', array('id'=>'create_scheduled_report', 'role'=>'form', 'class'=>'element-action-form')); ?>
		<div class="modal-body">
			<div class="row">
				<div class="col-md-12">
					...
					<div class="hidden">
						...
						<input type="hidden" name="user_timezone" value="<?php echo $user_timezone; ?>" />
						<input type="hidden" name="customer_seed" value="<?php echo $customer_seed; ?>" />
						<input type="hidden" name="customer_title" value="<?php echo $customer_title; ?>" />
			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						<input type="checkbox" id="email_dist_list" name="email_dist_list" value="1" <?php echo set_checkbox('email_dist_list', '1'); ?>>
		...
		<div class="modal-footer">
			...
			<button type="submit" class="btn btn-success form-submit-button" data-loading-text="Creating Schedule...">Create Scheduled Report</button>
		</div>
